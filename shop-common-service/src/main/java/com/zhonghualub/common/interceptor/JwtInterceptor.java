package com.zhonghualub.common.interceptor;

import com.zhonghualub.common.entity.ResultCode;
import com.zhonghualub.common.exception.CommonException;
...
public class JwtInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        System.out.println("进入统一认证中");
        // 1.通过request获取请求token信息
        String authorization = request.getHeader("X-Token");
        System.out.println("获取到token:" + authorization);
